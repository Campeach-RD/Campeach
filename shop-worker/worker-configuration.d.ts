/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=shop-worker/wrangler.jsonc shop-worker/worker-configuration.d.ts` (hash: 69b85c22dfb7f00604764e060c90e210)
// Runtime types generated with workerd@1.20260801.1 2026-08-13 nodejs_compat
interface __BaseEnv_Env {
	PAGADITO_MODE: "production";
	STORE_ORIGIN: "https://campeach-rd.github.io";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAGADITO_MODE" | "STORE_ORIGIN">> {}
}
